...
Forge 1.4 is the stable project-manager skill release with Token Saver defaults, route chaining quality gates, Next Step Protocol, Capability Hints, Idea Backlog, Work Summary, and AI orchestration.
