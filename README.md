...
Forge 2.0 is the Stable Core release: Token Saver by default, existing-project self-audit, field-test evidence, lightweight multi-agent collaboration planning, router contract regression, Dual Index human/machine indexes, Forge Doctor stability checks, route chaining quality gates, Next Step Protocol, Capability Hints, Idea Backlog, Work Summary, and AI orchestration.
