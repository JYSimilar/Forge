...
Forge 1.8 is the stable project-manager skill release with Token Saver defaults, stronger existing-project self-audit, field-test feedback improvements, lightweight multi-agent collaboration planning, a router contract for natural triggers and future pluginization, route chaining quality gates, Next Step Protocol, Capability Hints, Idea Backlog, Work Summary, and AI orchestration.
