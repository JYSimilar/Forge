...
Forge 1.5 is the stable project-manager skill release with Token Saver defaults, existing-project self-audit, lightweight multi-agent collaboration planning, route chaining quality gates, Next Step Protocol, Capability Hints, Idea Backlog, Work Summary, and AI orchestration.
...
接手已有工程时，Forge 会先看当前工作区有没有项目，再决定下一步。它会识别 manifest、README、测试线索、脚本、技术栈和明显风险，并能生成 `WORKSPACE_SUMMARY.md`。
